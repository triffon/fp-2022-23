...
-- Haskell може да предположи каква е типовата декларация,
-- но ние ще я пишем експлицитно!


-- сравнение: x == y
-- условен оператор: if <cond> then <expr> else <expr>
-- ламбда функция: \<arg1> ... <argn> -> <expr>
...
-- Мислете си за cond в scheme

-- Примери за функции/оператори:
--------------------------------
...
-- Прилагане на функция към аргумент.
-- ($) изчаква всичко отдясно да се оцени
-- (*2) 10 - 5 ~~> 15
-- (*2) (10 - 5) ~~> 10
-- (*2) $ 10 - 5 ~~> 10
