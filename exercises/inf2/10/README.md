...
1.  Дефинирайте функция `length'`, която намира дължината на списък

2. Дефинирайте функция `product'`, която намира произведението на елементите на подадния списък

3. Дефинирайте функция `maximum'`, която намира най-големия елемент в подадния списък

4. Дефинирайте функция `elem'`, която проверява далиелемент се съдържа в подадния списък

5. Дефинирайте функция `replicate'` n element, която конструира списък от `n` повторения на даден елемент

    ```haskell
    > replicate' 5 10 -- => [10, 10, 10, 10, 10]
    ```

6. Дефинирайте функция `zipWith'`, която по два подадени списъка образува нов, комбинирайки елементите им чрез дадена функция

7. Използвайте list comprehension, за да дефинирате `sumDivisors`, която намира сумата от делителите на дадено число

8. Използвайте list comprehension, за да дефинирате `prime`, която проверява дали дадено число е просто

9. Използвайте list comprehension, за да дефинирате  `descartes`, която намира декартово произведение на два списъка

10. Дефинирайте функция `histogram`, която за всяка уникална стойност от даден списък връща списък от наредени двойки от вида (<стойност>, <общ брой срещания>)
...
11. Дефинирайте функция `distance`, която намира разстоянието между две точки в равнината
