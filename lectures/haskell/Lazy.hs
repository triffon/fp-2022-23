...
-- [(3,4,5),(5,12,13),(8,15,17),(7,24,25),(20,21,29),(12,35,37),(9,40,41),(28,45,53),(11,60,61),(16,63,65)]
...
second :: a -> c -> c
second _ x = x
-- >>> second (length [1..10000000]) 2
-- 2

-- >>> seq (length [1..10000000]) 2
-- 2
